...
public class Structogramme {
            ...
            public static void main(String[] args) {
                ...
                for (int longueur = 1; longueur <= 9; longueur++) {
                    // Générer toutes les combinaisons possibles pour un mot de passe de la longueur donnée
                    for (int i = 0; i < Math.pow(10, longueur); i++) {
                        
                        // Formater le nombre pour qu'il ait toujours la longueur correcte (en ajoutant des zéros devant si nécessaire)
